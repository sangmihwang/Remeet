...
public class TTSService {
    ...
    private final String FLASK_API_URL = "http://localhost:5000/api/v1/tts";
    ...
    public STTResponseDto callFlaskApi(String answer, String voiceId) {
        ...
        HttpEntity<String> request = new HttpEntity<>(new JSONObject().put("answer", answer).put("voiceId", voiceId)
                .toString(), headers);
